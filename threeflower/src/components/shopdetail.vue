...
<div>
  ...
  <div id="shopdetail">
     ...
     <div class="detailright">
      ...
      <div>
        <span>价格</span><b style="color:#EA3131;font-size:24px">￥{{this.getdetail.price}}</b>
      </div>
      <div><span>运费</span><span style="padding-right:10px">浙江杭州</span>至<span style="padding-left:10px">成都</span>
      <span style="padding-left:10px">快递包邮</span></div>
       <div class="storecount">
        <div><span>销量</span><span style="color:red;padding-left:10px">{{this.getdetail.sale}}</span></div>
        <div>累计评价<span style="color:red;padding-left:10px">345</span></div>
        <div>送天猫积分<span style="color:green;padding-left:10px">50</span></div>
      </div>
      <div>
        <span>化妆品净含量</span><span>500g/ml</span>
      </div>
       <div class="addcount">
        <div style="padding-right:20px">数量</div>
        <div class="countbox">
          <div @click="countdown()"><img :src="this.reduce" alt=""></div>
          <div>{{this.count}}</div>
          <div @click="countup()"><img :src="this.add" alt=""></div></div>
      </div> 
        <div class="shopcar">
